...
Sou um desenvolvedor em formação, apaixonado por **tecnologia e programação**, com foco no desenvolvimento **Front-End** e **Mobile**, sempre buscando evoluir em lógica, experiência do usuário (UI/UX), arquitetura de aplicações e boas práticas de código.
...
- 🧩 Estudando **UI/UX**, responsividade e boas práticas de design
- 🛠️ Praticando lógica de programação, organização de código e versionamento
